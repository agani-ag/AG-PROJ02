...
urlpatterns = [
    ...
    path('presence/list', presence.presence_list, name='presence_list'),
    path('presence/leave', presence.presence_leave, name='presence_leave'),
    ...
    path('invoice/<int:invoice_id>/json/save', invoices.invoice_json_save, name='invoice_json_save'),
    path('invoice/<int:invoice_id>/json/restore', invoices.invoice_json_restore, name='invoice_json_restore'),
    ...
    path('invoice/to-quotation/<int:invoice_id>', quotation.invoice_to_quotation, name='invoice_to_quotation'),
    path('quotation/approve/<int:quotation_id>', quotation.quotation_approve, name='quotation_approve'),
    path('quotation/resync/<int:quotation_id>', quotation.quotation_resync_prices, name='quotation_resync_prices'),
