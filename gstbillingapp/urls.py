...
urlpatterns = [
    ...
    path('book/del/<int:booklog_id>', views.book_logs_del, name='book_logs_del'),
    ...
    path('inventory/del/<int:inventorylog_id>', views.inventory_logs_del, name='inventory_logs_del'),

    # Purchase URLs
    path('purchases', views.purchases, name='purchases'),
    path('purchases/add', views.purchases_add, name='purchases_add'),
    path('purchases/edit/<int:pid>', views.purchases_edit, name='purchases_edit'),
    path('purchases/delete/<int:pid>', views.purchases_delete, name='purchases_delete'),
]