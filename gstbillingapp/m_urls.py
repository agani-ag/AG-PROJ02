...
from .views.m.invoice_print import invoice_print
...
urlpatterns = [
    ...
    # ---- Original invoice document (shared: customer + employee) ----
    path('invoice/<int:invoice_id>/print', invoice_print, name='m_invoice_print'),
